...
database = pd.read_excel(r"E:\数据\其他癌症表达谱\PRAD\PRAD_Vec\PRAD_CeRNA.xlsx")
lnc_exp = pd.read_excel(r"E:\数据\其他癌症表达谱\PRAD\PRAD_correct\PRAD_lncRNA_exp.xlsx")
m_exp = pd.read_excel(r"E:\数据\其他癌症表达谱\PRAD\PRAD_correct\PRAD_mRNA_exp.xlsx")

# 读取三种RNA名称列表
with open(r"E:\数据\其他癌症表达谱\PRAD\PRAD_mRNA_name.txt", 'r') as file:
    mRNA_name = file.read().splitlines()

with open(r"E:\数据\其他癌症表达谱\PRAD\PRAD_miRNA_name.txt", 'r') as file:
    miRNA_name = file.read().splitlines()

with open(r"E:\数据\其他癌症表达谱\PRAD\PRAD_lncRNA_name.txt", 'r') as file:
...
df.to_excel("E:\数据\其他癌症表达谱\PRAD\PRAD_Vec\PRAD_zyb.xlsx")